...
namespace _Logic.Extensions.Popup
{
    public class Popup : MonoBehaviour
    {
        ...
        [field: SerializeField, HideInInspector] public string Format { get; set; } = "{0:0}";
        [field: SerializeField, HideInInspector] public int Id { get; set; }
        ...
        public void UpdateTime(float delta)
        {
            ...
            var position = Vector3.Lerp(_initialPosition, _endPosition, progress);
