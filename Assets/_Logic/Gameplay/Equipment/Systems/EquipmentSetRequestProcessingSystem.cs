...
namespace _Logic.Gameplay.Equipment.Systems
{
    ...
    public class EquipmentSetRequestProcessingSystem : AbstractUpdateSystem
    {
        ...
        private Stash<EquipmentsSetComponent> _equipmentsSetStash;
        private Stash<EquipmentComponent> _equipmentStash;
        ...
        public override void OnAwake()
        {
            ...
            _equipmentsSetStash = World.GetStash<EquipmentsSetComponent>();
            _equipmentStash = World.GetStash<EquipmentComponent>();
        ...
        public override void OnUpdate(float deltaTime)
        {
            foreach (var request in _equipmentSetRequest.Consume())
            {
                ...
                ref var equipmentsComponent = ref _equipmentsSetStash.Get(request.Entity, out var hasEquipmentsComponent);
                ...
                {
                    _equipmentsSetStash.Set(request.Entity, new EquipmentsSetComponent
                    {
        ...
        private void SetEquipmentToView(EquipmentData equipmentData, SlotType slotType, UnitProvider unit)
        {
            if (unit.Model is HumanoidModel humanoidModel)
            {
                ...
                humanoidModel.SetEquipment(slotType, equipmentData.Type, equipmentProvider);
                _equipmentStash.Set(equipmentProvider.Entity, new EquipmentComponent
                {
                    Data = equipmentData
                });
            }
